...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/breadability-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13202&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/breadability-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `breadability` can be installed with:

```
conda install breadability
```

It is possible to list all of the versions of `breadability` available on your platform with:
